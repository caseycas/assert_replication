INSERT INTO assert_july_2015_no_merge1.fc_everything_after_1st_assert_agg(
...
count(DISTINCT(author)) FROM assert_july_2015_no_merge1.fc_everything_after_1st_assert
